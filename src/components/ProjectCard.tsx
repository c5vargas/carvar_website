...
function ProjectCard({ project }: Props) {
	return project && (
		<article className="relative group flex items-center justify-center overflow-hidden shadow-xl w-full h-[412px] lg:h-[512px] rounded-3xl cursor-pointer">
				<div 
					...
					style={{backgroundImage: `url(/assets/portfolio/${project.image})`}} />
				<div className="absolute w-full h-full flex flex-col items-start justify-end p-6">
					...
					<p className="f-mono text-sm">{ project.descr }</p>
